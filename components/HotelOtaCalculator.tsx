        ...
        <div className="lg:col-span-7 bg-black/40 border border-white/5 p-6 md:p-8 rounded-[3.5rem] flex flex-col justify-between space-y-8 relative overflow-hidden backdrop-blur-md">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              />
              <div className="flex justify-between text-[9px] text-gray-500 font-mono">
                <span>10% (Baixa dependència)</span>
                <span>60% (Mitjana sector)</span>
                <span>95% (Dependència extrema)</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-end">
                <div className="flex flex-col">
                  <label className="text-[11px] uppercase tracking-wider text-gray-400 font-extrabold">
                    {t('verticals.hotels.roi_slider_comm', "Comissió mitjana d'OTAs")}
                  </label>
                </div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-end">
                <label className="text-[11px] uppercase tracking-wider text-gray-400 font-extrabold">
                  {t('verticals.hotels.roi_slider_recapture', 'Mètrica de reserves recuperades (SKIRION)')}
                </label>
              ...
              <div className="flex justify-between text-[9px] text-gray-500 font-mono">
                ...
                <span>5% (Molt viable)</span>
                <span>20% (Èxit consolidat)</span>
              </div>
            </div>
          ...
          <div className="bg-white/[0.02] border border-white/5 rounded-[2rem] p-5 space-y-3">
            <h4 className="text-xs uppercase font-black tracking-widest text-brand-primary flex items-center gap-1.5">
              ...
              {t('verticals.hotels.roi_ex_title', "EXEMPLE REAL SOBRE L'ESTADA D'UN CLIENT")}
            </h4>
            
            <div className="grid grid-cols-2 gap-4 text-xs">
              <div className="space-y-1 p-3 bg-black/40 rounded-xl border border-white/5">
                <p className="text-gray-500 text-[9px] uppercase tracking-wider">{t('verticals.hotels.roi_ex_night_price', 'Habitació')}</p>
                <p className="font-extrabold text-white text-xs">150 € / NIT</p>
                <p className="text-gray-500 text-[9px] uppercase tracking-wider pt-1">{t('verticals.hotels.roi_ex_stay', 'Estada mitjana')}</p>
                <p className="font-extrabold text-white text-xs">5 nits (750 € total)</p>
              </div>
              ...
              <div className="space-y-2 p-3 bg-red-500/[0.03] rounded-xl border border-red-500/10">
                <p className="text-red-400 text-[9px] uppercase tracking-wider font-bold">
                  {t('verticals.hotels.roi_ex_ota_cost', "Comissió de l'OTA")}</p>
                <p className="font-mono text-red-400 text-xs font-black">
                  -127,50 € ({otaCommission}%)
                </p>
                <p className="text-gray-400 text-[90%] leading-snug">
                  {t('verticals.hotels.roi_ex_recieved', "L'hotel només rep 622,50 € abans de despeses.")}
                </p>
              </div>
            </div>
            ...
            <div className="p-3 bg-emerald-500/[0.05] border border-emerald-500/10 rounded-xl flex items-center gap-2">
              ...
              <p className="text-[11px] text-emerald-400 font-extrabold leading-tight">
                {t('verticals.hotels.roi_ex_skirion_cost_val', "Amb SKIRION, aquests 127,50 € queden íntegrament a la vostra butxaca.")}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 pb-4 border-b border-white/5">
              ...
              <span className="text-xs uppercase font-black tracking-widest text-brand-primary">
                {t('verticals.hotels.roi_results_header', "PROJECCIÓ D'ESTALVI DE MARGE")}
              </span>
            </div>
            ...
            <div className="p-5 bg-red-500/[0.03] border border-red-500/15 rounded-[2rem] relative group hover:bg-red-500/[0.05] transition-all">
              ...
              <p className="text-[9px] uppercase tracking-[0.2em] text-red-400 font-black mb-1">
                {t('verticals.hotels.roi_card_commission_leak', "Marge absorbit per les comissions d'OTAs")}
              </p>
              ...
              <p className="text-[10px] text-gray-500/80 font-mono mt-1">
                Calculat sobre el {otaShare}% del seu volum total ({calculations.otaVolume.toLocaleString('es-ES', { maximumFractionDigits: 0 })} €)
              </p>
            </div>
            ...
            <div className="p-5 bg-white/5 border border-white/5 rounded-[2rem] relative group hover:bg-white/[0.08] transition-all">
              ...
              <p className="text-[9px] uppercase tracking-[0.2em] text-gray-400 font-black mb-1">
                {t('verticals.hotels.roi_card_recovered_revenue', "Facturació directa recuperada (Desviada)")}
              </p>
              ...
              <p className="text-[10px] text-gray-500 font-mono mt-1">
                Representa desviar només l'estable {recaptureRate}% de reserves d'OTAs al seu propi canal directe
              </p>
            </div>
            ...
            <div className="p-6 bg-emerald-500/[0.05] border border-emerald-500/25 rounded-[2.5rem] relative group overflow-hidden">
              ...
              <p className="text-[10px] uppercase tracking-[0.25em] text-emerald-400 font-black mb-1">
                💸 {t('verticals.hotels.roi_card_recovered_savings', "Estalvi net de comissions anual")}
              </p>
              <div className="text-4xl md:text-5xl font-black text-emerald-400 font-mono tracking-tighter drop-shadow-[0_0_20px_rgba(16,185,129,0.3)] select-none animate-pulse">
                {calculations.commissionSavings.toLocaleString('ca-ES', { maximumFractionDigits: 0 })} €
              </div>
              <p className="text-[11px] text-emerald-300/80 font-medium leading-relaxed mt-2">
                Aquest estalvi net de marge net supera habitualment x5 el retorn d'inversió en el sistema recurrent de SKIRION.
              </p>
            </div>
          ...
          <div className="pt-6 border-t border-white/5 flex flex-col gap-3">
            <div className="flex gap-2 items-center text-xs text-brand-primary">
              ...
              <p className="font-extrabold uppercase tracking-wider">
                {t('verticals.hotels.roi_claim', "DIAGNÒSTIC COMERCIAL DIRECTE")}</p>
            </div>
            
            <p className="text-[11px] text-gray-400 font-light leading-relaxed">
              * Els establiments hotelers solen canviar radicalment l'estratègia després de veure aquestes dades. Voleu que l'equip de SKIRION us prepari un excel de viabilitat de venda directa a mida?
            </p>
            ...
            >
              <span>{t('verticals.hotels.roi_cta', 'Reclamar anàlisi de comissions')}</span>
