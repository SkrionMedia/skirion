...
const CVModal: React.FC<CVModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      if (selectedFile.size > 10 * 1024 * 1024) {
        setErrorMsg('El archivo es demasiado grande. El límite es 10MB.');
        return;
      }
      setErrorMsg('');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name.trim() || !formData.email.trim()) {
      setErrorMsg('Por favor rellena tu nombre y correo electrónico.');
      return;
    }
    ...
    try {
      ...
      console.error(err);
      setErrorMsg('Ocurrió un error al enviar el formulario. También puedes enviar tu CV directamente a info@skirionmedia.com');
    } finally {
            ...
            <div className="text-center py-8 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-300 text-sm leading-relaxed max-w-md mx-auto">
                  Hemos enviado tu candidatura con el asunto <strong className="text-brand-primary">CV</strong> directamente a nuestro equipo en <strong className="text-white">info@skirionmedia.com</strong>.
                </p>
                <p className="text-gray-400 text-xs pt-2">
                  Si tu perfil encaja con las vacantes actuales o futuras, nos pondremos en contacto contigo lo antes posible.
                </p>
              </div>
              <button
                onClick={handleClose}
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
                  Adjunta tu currículum en PDF o Word. Se enviará directamente a nuestro correo <strong className="text-white">info@skirionmedia.com</strong> con el asunto <strong className="text-brand-primary">CV</strong>.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {file ? (
                      ...
                      <div className="space-y-2 pointer-events-none">
                        ...
                        <p className="text-xs font-semibold text-gray-300">
                          Haz clic para seleccionar tu CV o arrastra el archivo aquí
                        </p>
                        <p className="text-[10px] text-gray-500 font-mono">
                          Formatos aceptados: PDF, Word (Máx 10MB)
                        </p>
                      </div>
                    )}
                  </div>
                ...
                <div className="text-center pt-1">
                  <p className="text-[10px] text-gray-500">
                    O si prefieres enviar directamente desde tu email:{' '}
                    <a
