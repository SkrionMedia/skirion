                ...
                <>
                  ...
                  <div className="lg:col-span-5 p-6 md:p-8 bg-white/[0.01] flex flex-col justify-between h-[350px] md:h-[450px]">
                    ...
                    <div className="border-t border-white/5 pt-4">
                      <p className="text-[9px] uppercase font-black tracking-widest text-gray-500 mb-2">{lang === 'ca' ? 'PREGUNTES FREQÜENTS DEL CÀMPING:' : 'PREGUNTAS FRECUENTES DEL CAMPING:'}</p>
                      <div className="flex flex-wrap gap-2">
                        <button 
                          onClick={() => triggerChatResponse(
                            lang === 'ca' ? "S'admeten gossos als bungalows?" : "¿Se admiten perros en los bungalows?", 
                            lang === 'ca' ? "Sí, totalment! Som pet-friendly tant a les parcel·les de càmping com als nostres bungalows d'alta gamma per a tota la família." : "¡Sí, totalmente! Somos pet-friendly tanto en las parcelas de camping como en nuestros bungalows de alta gama para toda la familia.", 
                            'hotel'
                          )} 
                        ...
                        >
                          {lang === 'ca' ? "Admeteu gossos?" : "¿Admitís perros?"}
                        </button>
                        <button 
                          onClick={() => triggerChatResponse(
                            lang === 'ca' ? "Quin és l'horari de la piscina coberta?" : "¿Cuál es el horario de la piscina cubierta?", 
                            lang === 'ca' ? "La piscina coberta climatitzada està oberta cada dia de 09:00h a 21:00h. L'accés està completament inclòs en la vostra estada." : "La piscina cubierta climatizada está abierta cada día de 09:00h a 21:00h. El acceso está completamente incluido en vuestra estancia.", 
                            'hotel'
                          )} 
                          className="px-3 py-1.5 rounded-full bg-white/5 hover:bg-brand-primary/10 hover:text-brand-primary text-[10px] font-bold text-gray-400 border border-white/10 transition-all"
                        >
                          {lang === 'ca' ? "Horari piscina" : "Horario piscina"}
                        </button>
                        <button 
                          onClick={() => triggerChatResponse(
                            lang === 'ca' ? "Com funciona la reserva directa?" : "¿Cómo funciona la reserva directa?", 
                            lang === 'ca' ? "En reservar directament a la nostra web t'estalvies les comissions de plataformes externes (com Booking), tenint el millor preu garantit i prioritat de check-in." : "Al reservar directamente en nuestra web te ahorras las comisiones de plataformas externas (como Booking), teniendo el mejor precio garantizado y prioridad de check-in.", 
                            'hotel'
                          )} 
                          className="px-3 py-1.5 rounded-full bg-white/5 hover:bg-brand-primary/10 hover:text-brand-primary text-[10px] font-bold text-gray-400 border border-white/10 transition-all"
                        >
                          {lang === 'ca' ? "Reserva directa" : "Reserva directa"}
                        </button>
                      </div>
                    </div>
                  </div>
              ...
              {sectorKey === 'clinics' && (
                <>
                  ...
                  <div className="lg:col-span-5 p-6 md:p-8 bg-white/[0.01] flex flex-col justify-between h-[350px] md:h-[450px]">
                    ...
                    <div className="border-t border-white/5 pt-4">
                      <p className="text-[9px] uppercase font-black tracking-widest text-gray-500 mb-2">{lang === 'ca' ? 'PREGUNTES DE VISITANTS:' : 'PREGUNTAS DE VISITANTES:'}</p>
                      <div className="flex flex-wrap gap-2">
                        <button 
                          onClick={() => triggerChatResponse(
                            lang === 'ca' ? "Quins tractaments de benestar oferiu?" : "¿Qué tratamientos de bienestar ofrecéis?", 
                            lang === 'ca' ? "Oferim massatges terapèutics, facials d'alta gamma, tractaments amb pedres calentes i circuits d'aigües termals personalitzats per al teu total relax." : "Ofrecemos masajes terapéuticos, faciales de alta gama, tratamientos con piedras calientes y circuitos de aguas termales personalizados para tu total relax.", 
                            'clinic'
                          )} 
                          className="px-3 py-1.5 rounded-full bg-white/5 hover:bg-brand-primary/10 hover:text-brand-primary text-[10px] font-bold text-gray-400 border border-white/10 transition-all"
                        >
                          {lang === 'ca' ? "Tractaments i massatges" : "Tratamientos y masajes"}
                        </button>
                        <button 
                          onClick={() => triggerChatResponse(
                            lang === 'ca' ? "Com puc reservar el circuit d'aigües?" : "¿Cómo puedo reservar el circuito de aguas?", 
                            lang === 'ca' ? "Pots reservar el teu circuit spa en un instant a través d'aquest mateix xat o trucant directament per garantir la millor hora disponible." : "Puedes reservar tu circuito spa en un instante a través de este mismo chat o llamando directamente para garantizar la mejor hora disponible.", 
                            'clinic'
                          )} 
                          className="px-3 py-1.5 rounded-full bg-white/5 hover:bg-brand-primary/10 hover:text-brand-primary text-[10px] font-bold text-gray-400 border border-white/10 transition-all"
                        >
                          {lang === 'ca' ? "Reserva de circuit" : "Reserva de circuito"}
                        </button>
                        <button 
                          onClick={() => triggerChatResponse(
                            lang === 'ca' ? "Quin és l'horari i tarifes del centre?" : "¿Cuál es el horario y tarifas del centro?", 
                            lang === 'ca' ? "Obrim de dilluns a diumenge de 09:00h a 22:00h. Els circuits individuals comencen des de 35€ per sessió completa." : "Abrimos de lunes a domingo de 09:00h a 22:00h. Los circuitos individuales comienzan desde 35€ por sesión completa.", 
                            'clinic'
                          )} 
                          className="px-3 py-1.5 rounded-full bg-white/5 hover:bg-brand-primary/10 hover:text-brand-primary text-[10px] font-bold text-gray-400 border border-white/10 transition-all"
                        >
                          {lang === 'ca' ? "Horari i preus" : "Horario y precios"}
                        </button>
                      </div>
                    </div>
                  </div>
                ...
                <>
                  <div className="lg:col-span-7 border-b lg:border-b-0 lg:border-r border-white/10 relative h-[350px] md:h-[450px] bg-black rounded-[2rem] overflow-hidden group">
                    ...
                    <div className="absolute top-4 left-4 z-10 flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-black/60 backdrop-blur-md border border-white/15">
                      ...
                      <span className="text-[10px] md:text-xs font-black uppercase tracking-wider text-white">Model 3D Interactiu</span>
                    </div>
                  ...
                  <div className="lg:col-span-5 p-6 md:p-8 bg-white/[0.01] flex flex-col justify-between h-[350px] md:h-[450px]">
                    <div>
                      ...
                      <div className="space-y-4 py-4 h-[180px] md:h-[230px] overflow-y-auto font-sans">
                        <div className="p-3 bg-white/5 rounded-2xl max-w-[85%] text-xs font-light tracking-wide leading-relaxed">
                          {lang === 'ca' ? "Hola! Sóc el teu assistent virtual. Explora el nostre showroom 3D i pregunta'm sobre preus de transport, mides, rebaixes o enviaments." : "¡Hola! Soy tu asistente de compras. Explora el showroom 3D y pregúntame sobre envíos, plazos, ofertas o tallas."}
                        </div>
                    ...
                    <div className="border-t border-white/5 pt-4">
                      <p className="text-[9px] uppercase font-black tracking-widest text-gray-500 mb-2">{lang === 'ca' ? 'PREGUNTES DE COMPRA HOT:' : 'PREGUNTAS DE COMPRA:'}</p>
                      <div className="flex flex-wrap gap-2">
                        <button onClick={() => triggerChatResponse(lang === 'ca' ? "Quins costos d'enviament teniu?" : "¿Costos de envío?", lang === 'ca' ? "Són gratuïts en comandes superiors a 50€!" : "¡Gratis en compras superiores a 50€!", 'ecommerce')} className="px-3 py-1.5 rounded-full bg-white/5 hover:bg-brand-primary/10 hover:text-brand-primary text-[10px] font-bold text-gray-400 border border-white/10 transition-all">{lang === 'ca' ? "Quins costos d'enviament teniu?" : "¿Costos de envío?"}</button>
                        <button onClick={() => triggerChatResponse(lang === 'ca' ? "Com funciona la devolució?" : "¿Cómo devuelvo?", lang === 'ca' ? "Tens 30 dies de devolució completament gratuïta." : "Dispones de 30 días de devolución gratis.", 'ecommerce')} className="px-3 py-1.5 rounded-full bg-white/5 hover:bg-brand-primary/10 hover:text-brand-primary text-[10px] font-bold text-gray-400 border border-white/10 transition-all">{lang === 'ca' ? "Com funciona la devolució?" : "¿Cómo devuelvo?"}</button>
                      </div>
                    </div>
                  </div>
                </>
                  ...
                  <div className="lg:col-span-7 p-6 border-b lg:border-b-0 lg:border-r border-white/10 relative h-[350px] md:h-[450px] bg-black/80 flex flex-col justify-between font-mono">
                      ...
                      <div className="space-y-2 py-4 h-[180px] md:h-[240px] overflow-y-auto text-[11px] text-gray-300 leading-normal select-none">
                        {consoleLogs.length === 0 ? (
                          <div className="text-gray-500 text-center pt-8 italic">
                            {lang === 'ca' ? 'Fes clic en una query per simular la rastrejabilitat de la IA generativa...' : 'Haz clic en una query para simular el rastreo de la IA generativa...'}
                          </div>
                        ) : (
                    ...
                    <div className="border-t border-white/10 pt-3">
                      <p className="text-[9px] text-gray-500 uppercase tracking-widest mb-2">
                        {lang === 'ca' ? 'PROMPT INVOCAT EN MOTORS IA:' : 'PROMPT INVOCADO EN MOTORES IA:'}
                      </p>
                      <div className="grid grid-cols-3 gap-2">
                        <button onClick={() => runGeoQuerySearch('hotel')} className="px-2 py-1.5 rounded-lg bg-white/5 hover:bg-brand-primary/10 border border-white/10 text-[9px] text-gray-300 uppercase transition-all truncate text-left">
                          🏨 {lang === 'ca' ? 'Hotel Catalunya' : 'Hotel Cataluña'}
                        </button>
                        <button onClick={() => runGeoQuerySearch('clinic')} className="px-2 py-1.5 rounded-lg bg-white/5 hover:bg-brand-primary/10 border border-white/10 text-[9px] text-gray-300 uppercase transition-all truncate text-left">
                          🩺 {lang === 'ca' ? 'Clínica Dental' : 'Clínica Dental'}
                        </button>
                        <button onClick={() => runGeoQuerySearch('kitchen')} className="px-2 py-1.5 rounded-lg bg-white/5 hover:bg-brand-primary/10 border border-white/10 text-[9px] text-gray-300 uppercase transition-all truncate text-left">
                          🍳 {lang === 'ca' ? 'Cuina Disseny' : 'Cocina Diseño'}
                        </button>
                      </div>
                    </div>
                  </div>
                        ...
                        {activeQuery ? (
                          <div className="p-4 bg-white/[0.02] border border-white/10 rounded-3xl relative overflow-hidden font-sans">
                            ...
                            <p className="text-xs font-bold text-white mb-2 uppercase tracking-wide">
                              {activeQuery === 'hotel' ? (lang === 'ca' ? '🏨 Hotel Rural Serene' : '🏨 Hotel Rural Serene') :
                               activeQuery === 'clinic' ? (lang === 'ca' ? '🩺 Clínica Dental Invisalign' : '🩺 Clínica Dental Invisalign') :
                               (lang === 'ca' ? '🍳 Cuines de Disseny Elegance' : '🍳 Cocinas de Diseño Elegance')}
                            </p>
                          ...
                          <div className="text-center text-xs text-gray-500 italic py-10">
                            {lang === 'ca' ? 'Esperant que s\'iniciï la cerca generativa des de la consola esquerra...' : 'Esperando a que se inicie la búsqueda generativa desde la consola izquierda...'}
                          </div>
                        )}
                      </div>
                    </div>
